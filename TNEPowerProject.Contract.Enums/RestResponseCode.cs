namespace TNEPowerProject.Contract.Enums
{
    /// <summary>
    /// Представляет список кодов ответа для Restful API
    /// </summary>
    public enum RestResponseCode
    {
        #region Success codes [2XX]
        /// <summary>
